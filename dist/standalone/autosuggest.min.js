  ...
  return (function(e) {
    ...
    function(e, t, n) {
          ...
          return u(t, e), a(t, [
              ...
              value: function(e) {
                (0, d.default)(e.suggestions, this.props.suggestions)
                  ...
                  : this.willRenderSuggestions(e)
                      ? (e.highlightFirstSuggestion &&
                          this.highlightFirstSuggestion(), this.state
                          .isCollapsed &&
            ...
            },
            {
              ...
              value: function(e, t, n) {
                this.setState(function(o) {
                  var r = o.valueBeforeUpDown;
                  return null === t
                    ? (r = null)
                    : null === r &&
                        'undefined' != typeof n &&
                        (r = n), { highlightedSectionIndex: e, highlightedSuggestionIndex: t, valueBeforeUpDown: r };
                });
              }
            },
            {
            ...
            },
            {
              ...
              value: function(e) {
                ...
                throw (console.error('Clicked element:', e), new Error(
                  "Couldn't find suggestion element"
                ));
              }
            },
            {
              ...
              value: function(e, t, n) {
                var o = this.props.inputProps, r = o.value, i = o.onChange;
                  ...
                  D = s({}, u, {
                    ...
                    onBlur: function(t) {
                      return e.justClickedOnSuggestionsContainer
                        ? (e.input.focus(), void (e.justClickedOnIgnored &&
                            setTimeout(function() {
                              (e.justClickedOnSuggestionsContainer = !1), (e.justClickedOnIgnored = !1), e.input.blur();
                            })))
                        : ((e.blurEvent = t), void (e.justSelectedSuggestion ||
                            (e.onBlur(), e.onSuggestionsClearRequested())));
                    },
                    onChange: function(t) {
                      var n = t.target.value, o = O(n);
                      e.maybeCallOnChange(t, n, 'type'), e.setState({
                        highlightedSectionIndex: null,
                        highlightedSuggestionIndex: null,
                        valueBeforeUpDown: null,
                        isCollapsed: !o
                      }), o ? r({ value: n }) : e.onSuggestionsClearRequested();
                    },
                    onKeyDown: function(t, o) {
                      switch (t.key) {
                        ...
                        case 'ArrowUp':
                          if (b)
                            O(C) && (r({ value: C }), e.revealSuggestions());
                          else if (n.length > 0) {
                            var i = o.newHighlightedSectionIndex,
                        ...
                        case 'Escape':
                          ...
                          c
                            ? (e.onSuggestionsClearRequested(), e.closeSuggestions())
      ...
      var b = function() {
        ...
        (this.onDocumentMouseDown = function(t) {
          (e.justClickedOnSuggestionsContainer = !1), (e.justClickedOnIgnored = !1);
          for (
            ...
            if (
              (null !== n.getAttribute('data.suggestion-ignore') &&
                (e.justClickedOnIgnored = !0), n === e.suggestionsContainer)
            )
          ...
          var o = n.sectionIndex, r = n.itemIndex;
          e.updateHighlightedSuggestion(o, r);
          ...
          var n = t.containerProps,
            o = t.children,
            r = e.props.renderSuggestionsContainer;
          return r({ containerProps: n, children: o, query: e.getQuery() });
        });
      };
        ...
        C = (function(e) {
          function t(e) {
            ...
            return (n.storeInputReference = function(e) {
              ...
              var o = n.props.id, r = null === e ? '' : 'section-' + e;
              return 'react-autowhatever-' + o + '-' + r + '-item-' + t;
                ...
                return r.map(function(n, r) {
                  ...
                  return g.default.createElement(
                    ...
                    g.default.createElement(b.default, {
                      ...
                      renderItemData: u,
                      sectionIndex: r,
                      highlightedItemIndex: a === r ? l : null,
    ...
    function(e, t) {
      ...
      e.exports = function(e) {
        ...
        function r(e) {
          var o = n(e, 2), r = o[0], i = o[1];
          return a
            ? null === i || i === s[r] - 1
                ? ((r = t(r)), null === r ? [null, null] : [r, 0])
                : [r, i + 1]
            : 0 === s || i === s - 1
                ? [null, null]
        ...
        function i(e) {
          ...
          return a
            ? null === i || 0 === i
                ? ((r = o(r)), null === r ? [null, null] : [r, s[r] - 1])
                : [r, i - 1]
            : 0 === s || 0 === i
                ? [null, null]
        ...
        var s = e.data, a = e.multiSection;
        return { next: r, prev: i, isLast: u };
      };
    },
    function(e, t, n) {
      'use strict';
    ...
    function(e, t) {
      ...
      function n(e, t) {
        ...
        var u = {}, s = void 0, a = void 0;
        for ((s = 0), (a = n.length); s < a; s++)
          u[n[s]] = !0;
        for ((s = 0), (a = r.length); s < a; s++) {
          var l = r[s], c = e[l], g = t[l];
          if (c !== g) {
            if (
              !u[l] ||
              null === c ||
              ...
              return !0;
            var f = Object.keys(c), d = Object.keys(g);
              ...
              value: function() {
                ...
                return c.default.createElement(
                  ...
                  n.map(function(t, n) {
                    ...
                    return m &&
                      (I.ref =
                        e.storeHighlightedItemReference), c.default.createElement(h.default, s({}, I, { sectionIndex: u, itemIndex: n, item: t, renderItem: r, renderItemData: i }));
                  })
                );
              }
            }
        ...
        m = (function(e) {
          function t() {
            ...
            return (n = o = u(
              ...
              var t = o.props, n = t.sectionIndex, r = t.itemIndex;
          ...
          return s(t, e), l(t, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return delete i.sectionIndex, delete i.itemIndex, 'function' ==
                  typeof i.onMouseEnter &&
                  (i.onMouseEnter = this.onMouseEnter), 'function' ==
                  typeof i.onMouseLeave &&
                  (i.onMouseLeave = this.onMouseLeave), 'function' ==
                  typeof i.onMouseDown &&
                  (i.onMouseDown = this.onMouseDown), 'function' ==
                  typeof i.onClick &&
                  (i.onClick = this.onClick), g.default.createElement(
                  'li',
                  a({ role: 'option' }, i, { ref: this.storeItemReference }),
                  n(t, o)
                );
              }
            }
